...
const generateProduction = function(publicPath, staticPath) {
...
const generate = function(debug, publicPath, staticPath) {
  const generator = debug ? generateDebug : generateProduction;
